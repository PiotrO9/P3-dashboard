<template>
  <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-slate-900 dark:via-blue-900 dark:to-indigo-900 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
      <div>
        <div class="flex justify-center">
          <div class="icon-gradient p-4 rounded-2xl shadow-xl">
      ...
      <UCard class="glass-card dark:glass-card-dark p-8 shadow-2xl border-0 ring-1 ring-slate-200/60 dark:ring-slate-700/60">
        <UForm
          ref="form"
          :schema="schema"
          :state="state"
        ...
        >
          ...
          <div class="flex items-center justify-between">
            ...
            <ULink class="text-sm text-blue-700 hover:text-blue-900 dark:text-blue-400 dark:hover:text-blue-300 font-semibold transition-colors duration-200 underline decoration-2 underline-offset-2">
        ...
        <div class="mt-6">
            ...
            <div class="relative flex justify-center text-sm">
              <span class="px-4 bg-white/95 dark:bg-slate-800/95 text-slate-600 dark:text-slate-300 font-semibold backdrop-blur-sm">Don't have an account?</span>
            </div>
