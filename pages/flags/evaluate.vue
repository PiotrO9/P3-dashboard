  ...
  <div class="space-y-6">
    <div>
      ...
      <p class="mt-1 text-sm text-gray-600">
        Test your feature flags with different contexts and conditions.
      </p>
    </div>
        ...
        <div v-else class="space-y-4">
          ...
          <div class="space-y-3">
            ...
            <div v-if="lastEvaluation.context && Object.keys(lastEvaluation.context).length > 0">
              ...
              <pre class="mt-1 text-sm text-gray-900 bg-gray-50 p-3 rounded overflow-auto">{{ JSON.stringify(lastEvaluation.context, null, 2) }}</pre>
            </div>
