	...
	<div class="space-y-6">
		<div class="flex justify-between items-center">
			<div>
				...
				<p class="mt-1 text-sm text-gray-600">Manage and toggle your feature flags</p>
			</div>

			<UButton icon="i-heroicons-plus" size="lg" @click="navigateTo('/flags/new')"> Add Flag </UButton>
		</div>
					...
					<div v-if="selectedFlag?.rules?.length" class="space-y-2">
						...
						>
							<div>
								...
								<p class="text-xs text-gray-500 mt-1">Returns: {{ rule.value ? 'true' : 'false' }}</p>
							</div>
